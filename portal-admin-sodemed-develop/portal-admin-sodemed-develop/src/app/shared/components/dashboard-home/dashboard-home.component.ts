...
@Component({
    ...
    standalone: true,
    template: `<div class="tw-w-full tw-h-full tw-flex tw-flex-col" style="height: calc(100vh - 200px);">
                     <div class="tw-flex tw-flex-col tw-justify-center tw-items-start">
                             ...
                             <p class="tw-text-stone-600 tw-text-2xl  my-1">Al Portal Administrativo</p>
                        </div>
